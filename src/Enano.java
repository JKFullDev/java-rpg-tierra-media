...
public class Enano extends Personaje{
	...
	public Enano() {
		super("Thorin", null, null, null, 150, 95, 100, 120, 3);
		this.resistencia = 10;
	}
	...
	public void atacar (boolean usarAtaqueEspecial, Personaje rival) {
		...
		boolean plusResistencia =  rand.nextInt(100) < this.resistencia;
		
		if(plusResistencia) {
			this.defensa+=15;
			System.out.println();
			System.out.println("\t\t\t  "+"¡Thorin ha aumentado su defensa en 15 puntos!");
		}
	...
	public void invocar() {
		...
		vida+=10;
		System.out.println();
        System.out.println("\t\t\t  "+this.nombre + " invoca la Gloria de los Enanos y gana +30 defensa y 10 puntos de vida!");
    }
